      ...
      <div className="h-full flex">
        ...
        <div className="lg:pl-64 flex flex-col w-0 flex-1">
          ...
          <div className="flex-1 relative z-0 flex overflow-hidden">
            <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none xl:order-last lg:pl-96 flex flex-col w-0">
              {/* Breadcrumb */}
            ...
            <aside className="hidden xl:order-first xl:flex xl:flex-col flex-shrink-0 w-96 border-r border-gray-200 lg:flex lg:fixed lg:inset-y-0">
              ...
              <nav className="flex-1 min-h-0 overflow-y-auto" aria-label="Directory">
                {Object.keys(directory).map((letter: any) => (
