...
export default function AxpMain({ props }: any) {
  return <>
    <Head>
      <title>Inicio - Clínica Ortega</title>
    </Head>
    <div className="relative py-16 bg-white">
      <div className="hidden absolute top-0 inset-x-0 h-1/2 bg-gray-50 lg:block" aria-hidden="true" />
      <div className="max-w-7xl mx-auto bg-blue-500 lg:bg-transparent lg:px-8">
        <div className="lg:grid lg:grid-cols-12">
            ...
            <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
              <div className="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                <img
                  ...
                  src="/imgs/img-inicio-trabajador.jpg"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="relative bg-blue-500 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
              ...
              <svg className="absolute bottom-full left-full transform translate-y-1/3 -translate-x-2/3 xl:bottom-auto xl:top-0 xl:translate-y-0" width={404} height={384} fill="none" viewBox="0 0 404 384" aria-hidden="true">
                <defs>
                  <pattern id="64e643ad-2176-4f86-b3d7-f2c5da3b6a6d" x={0} y={0} width={20} height={20} patternUnits="userSpaceOnUse">
                    <rect x={0} y={0} width={4} height={4} className="text-indigo-500" fill="#60a5fa" />
                  </pattern>
                </defs>
            ...
            <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              <h2 className="text-3xl font-extrabold text-white" id="join-heading">
                Bienvenido al <p></p> Aplicativo Web
              </h2>
              <p className="text-lg text-white">
                Somos la institución privada de salud más grande e importante de la región central del Perú.
                Con más de 45 años de trayectoria, la Clínica Ortega se ha convertido en sinónimo de excelencia.
              </p>
