...
function AxButtonGuardar({ loading, tipoEdicion }: any) {
    ...
    return <button type="submit"
        className={"focus:ring-indigo-500 disabled:bg-indigo-400 bg-indigo-600 hover:bg-indigo-700 ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white  focus:outline-none focus:ring-2 focus:ring-offset-2"
        }
        disabled={loading} >
        {
            loading &&
...
export default function AxRequisito({ idRequisito, setIdRequisito, setLuegoEdicion }: any) {
    ...
    const handleSubmit = async (event: any) => {
        ...
        const dataEnvio = JSON.stringify({ ...formData, UrlImage: imgurl, idRequisito: idRequisito });
                                        ...
                                        <div className="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                            <div className="space-y-1 text-center">
                                                ...
                                                <div className="visibility: hidden">
                                                    <AxInput name="UrlImage" label="Url Image" value={formData.UrlImage ? formData.UrlImage : imgurl} handleChange={handleChange} />
                                                </div>
                                            </div>
                                        ...
                                        >
                                            <li key={formData.id}>
                                                <div className="space-y-4">
                                                    <img className="object-cover shadow-lg rounded-lg" src={formData.UrlImage} alt="" />
