...
export default function AxInicioEmpleado() {
    ...
    return (
        <div className="relative overflow-hidden">
            <main>
                <div className="pt-10 bg-gray-900 w-full h-full sm:pt-16 lg:pt-0 lg:pb-0 lg:overflow-hidden">
                    <div className="mx-auto max-w-7xl lg:px-8">
                        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                                <div className="lg:py-24">
                                    <h1 className="mt-4 text-6xl sm:text-2xl tracking-tight font-extrabold  text-white sm:mt-5 dm:text-6xl lg:mt-6 xl:text-6xl">
