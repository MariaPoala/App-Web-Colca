...
export default function AxBtnModalCancelar({ setEstadoEdicion, setOpen }: any) {
    return <button onClick={() => { setEstadoEdicion(EnumEstadoEdicion.CANCELADO); setOpen(false); }} type="button"
