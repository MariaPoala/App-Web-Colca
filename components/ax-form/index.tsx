import AxCheck from 'components/ax-form/ax-check'
import AxInput from 'components/ax-form/ax-input'
import AxRadio from 'components/ax-form/ax-radio'
import { AxSelect, AxSelectFiltro } from 'components/ax-form/ax-select'
import AxSelectMultiple from 'components/ax-form/ax-select-multiple'
...
export {
    ...
    AxBtnModalCancelar, AxBtnCancelar, AxModalEliminar
}